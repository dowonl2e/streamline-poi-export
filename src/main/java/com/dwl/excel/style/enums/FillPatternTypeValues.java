...
public enum FillPatternTypeValues {
  ...
  private final FillPatternType poiFillPatternType;

  FillPatternTypeValues(FillPatternType poiFillPatternType) {
    this.poiFillPatternType = poiFillPatternType;
  }

  public FillPatternType getPoiFillPatternType() {
    return poiFillPatternType;
  }
}
